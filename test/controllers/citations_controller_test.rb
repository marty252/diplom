...
class CitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citation" do
    assert_difference('Citation.count') do
      post citations_url, params: { citation: { page: @citation.page, publication_id: @citation.publication_id } }
    end
  ...
  test "should update citation" do
    patch citation_url(@citation), params: { citation: { page: @citation.page, publication_id: @citation.publication_id } }
